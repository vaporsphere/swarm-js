...
const indexHtml = new Buffer(
  `<html>
    <body>
      <h3><img src="vapory_icon.png"/> Swarm.js example DApp!</h3>
...
// This is a 16x16 Vapory icon png.
const vaporyIconPng = new Buffer([
...
const exampleDApp = {
  ...
  "/vapory_icon.png"   : {type: "image/png", data: vaporyIconPng},
